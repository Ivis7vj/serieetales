                        ...
                        {reviews.map((review) => (
                            <div key={review.id || Math.random()} style={{
                                ...
                                <div style={{
                                    ...
                                    {review.photoURL ? (
                                        <img src={review.photoURL} alt="User" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                    ) : (
                                        <MdPerson size={24} color="#FFCC00" />
                                    )}
                                </div>
                                ...
                                <div style={{
                                    ...
                                    {currentUser && review.userId === currentUser.uid && (
                                        <>
                                            ...
                                            {/* <button onClick={() => handleShare(review)} style={{ background: 'transparent', border: 'none', color: '#666', cursor: 'pointer' }}><MdShare size={20}/></button> */}
