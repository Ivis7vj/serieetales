...
export const logActivity = async (user, type, data) => {
    ...
    try {
        ...
        const activityDoc = {
            ...
            type: type, // 'watched_episode' -> 'watched', 'completed_season' -> 'finished', etc.
            // Mapping handled at call site or here? 
            // User requested "stored... precisely". 
            // Let's standardise the TYPES stored:
            // 'watched' (ep), 'finished' (season), 'rated' (season), 'liked' (season/series), 'watchlisted' (series)
            // But I need to preserve 'poster_updated'.
